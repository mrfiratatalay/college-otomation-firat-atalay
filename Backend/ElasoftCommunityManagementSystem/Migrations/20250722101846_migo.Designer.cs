...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.DailySlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.DisabledSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.EventModel", b =>
                {
                    ...
                    b.Property<string>("ApplicationFormDocumentId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ManagementBoardFormDocumentId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ResultReportDocumentId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.EventReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DisabledDatesSerialized")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ValidDaysSerialized")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.SettingModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.TimeSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.DailySlot", b =>
                {
                    b.HasOne("ElasoftCommunityManagementSystem.Models.Location", "Location")
                        .WithMany("DailySlots")
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.DisabledSlot", b =>
                {
                    ...
                    b.HasOne("ElasoftCommunityManagementSystem.Models.DailySlot", "Slot")
                        .WithMany()
            ...
            modelBuilder.Entity("ElasoftCommunityManagementSystem.Models.EventReservation", b =>
                {
                    ...
                    b.HasOne("ElasoftCommunityManagementSystem.Models.DailySlot", "TimeSlot")
                        .WithMany()
                        .HasForeignKey("TimeSlotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ElasoftCommunityManagementSystem.Models.TimeSlot", null)
                        .WithMany("Reservations")
